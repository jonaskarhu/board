...
class JourneyPlanner:
    ...
    def departureboard(self, stop_id, date=None, direction=None,
                       time_span=None, max_departures_per_line=None):
        """ departureBoard """
        date = date if date else datetime.now()
        request_parameters = {
            'id': stop_id,
        ...
        if time_span is not None and max_departures_per_line is not None:
            request_parameters['timeSpan'] = time_span
            request_parameters['maxDeparturesPerLine'] = max_departures_per_line
        response = self._request(
            'departureBoard',
            **request_parameters)
